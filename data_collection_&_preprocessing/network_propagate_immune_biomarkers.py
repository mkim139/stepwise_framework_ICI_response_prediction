...
exec(open('/home/mkim/Netbio/code/utilities/network_utilities_ver4.py').read())
exec(open('/home/mkim/Netbio/code/utilities/useful_utilities.py').read())
start = time.ctime()
...
string_cutoff = 700
# fo_dir = '../../result'
fo_dir = '/home/mkim/Netbio/result/0_data_collection_and_preprocessing'

## Prepare data

#  Load immunotherapy biomarkers
# ib = pd.read_csv('../../data/Marker_summary.txt', sep='\t')
# ib = pd.read_csv('/home/mkim/Netbio/data/Marker_summary2.txt', sep='\t')
# ib = pd.read_csv('/home/mkim/Netbio/data/Marker_summary6.txt', sep='\t')
# ib = pd.read_csv('/home/mkim/Netbio/data/Marker_summary_prof.txt', sep='\t')
# ib = pd.read_csv('/home/mkim/Netbio/data/Marker_summary_IBE.txt', sep='\t')
ib = pd.read_csv('/home/mkim/Netbio/data/Marker_summary_KEAP.txt', sep='\t')

#  Construct Network (STRING network v11)
print('constructing STRING PPI network, %s'%time.ctime())
tmp_G = nx.Graph()
annotation = pd.read_csv('/home/mkim/Netbio/data/9606.protein.aliases.v12.0.txt', sep='\t') # STRING network ensembl-geneID mapping
net = pd.read_csv('/home/mkim/Netbio/data/9606.protein.links.v12.0.txt', sep=' ') # STRING network
nodes1 = net.values[:,0]
nodes2 = net.values[:,1]
scores = net.values[:,2]
